...
var 
 MMC_DEFAULT_LOG_LEVEL:LongWord = MMC_LOG_LEVEL_NONE; {Minimum level for MMC messages.  Only messages with level greater than or equal to this will be printed}
...
begin
 ...
 if (SDHCI.Device.DeviceFlags and SDHCI_FLAG_NON_STANDARD) <> 0 then
  ...
  begin
   ...
   if MMC_AUTO_DEVICE_CREATE then
    begin
     {Create MMC}
     MMC:=MMCDeviceCreate;
     if MMC = nil then
