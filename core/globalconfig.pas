...
var
 ...
 {MMC}
 MMC_AUTO_DEVICE_CREATE:LongBool = True; {If true the the SDHCIHostStart procedure will create an MMC device by default}
...
var
 ...
 BCM2708_REGISTER_I2C2:LongBool = True;     {If True then register the BCM2708 I2C1 device during boot (Only if BCM2708 unit included)}
